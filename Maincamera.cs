...
{
    private Vector3 firstlocation = new Vector3(300, 700, 200); //메인카메라 처음위치
    ...
    void LateUpdate()
    {
        ...
        if(target != null)
        {
            Debug.Log("Maincamera: " + target.object_name.GetComponent<Move>().objectID + " leftclick = " + target.leftclick + " rightclick = " + target.rightclick);
        }
    }
}
